...
# Pegando pessoas com depressão Q092 = 1, 
withDepression = data.loc[(data['Q092'] == 1)]
# Pegando pessoas sem depressao Q092 = 2
withoutDepression = data.loc[(data['Q092'] == 2)]

print("Total da base: " + str(len(data.index)))
print("Total com depressao: " + str(len(withDepression.index)))
print("Total sem depressao: " + str(len(withoutDepression.index)))

withDepression.to_csv('TableDepression.csv')
withDepression.to_csv('TableNoDepression.csv')